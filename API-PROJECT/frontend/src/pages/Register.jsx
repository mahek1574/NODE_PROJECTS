    ...
    <div className="flex-1 bg-gray-950 flex items-center justify-center py-12 px-6 relative overflow-hidden">
      ...
      <div className="relative w-full max-w-md bg-gray-900/60 backdrop-blur-md border border-gray-800 rounded-3xl p-8 sm:p-10 shadow-2xl">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400 text-sm">Join MusicHub and start streaming</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-purple-600 hover:bg-purple-500 text-white font-bold py-3.5 px-4 rounded-xl transition-all duration-200 shadow-md shadow-purple-500/10 disabled:opacity-50 mt-2 cursor-pointer"
          >
